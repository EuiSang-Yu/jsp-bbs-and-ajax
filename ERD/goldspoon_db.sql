...
CREATE OR REPLACE TRIGGER TRI_COMMENT_comment_no BEFORE INSERT ON COMMENT
FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER TRI_FILE_file_no BEFORE INSERT ON FILE
FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER TRI_MEMBER_member_no BEFORE INSERT ON MEMBER
FOR EACH ROW
BEGIN
